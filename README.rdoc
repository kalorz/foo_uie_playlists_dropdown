...
2. In file +window.h+, replace
     <tt>window_factory() : service_factory_base(window::class_guid)</tt>
   definition with 
     <tt>window_factory() : service_factory_base(window::class_guid, service_factory_traits<window>::factory_list())</tt>
